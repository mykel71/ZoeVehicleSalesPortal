...
namespace SalesPortal.Controllers
{
    public class ModelsController : Controller
    {
        ...
        public async Task<IActionResult> Create([Bind("Id,PictureURL,FullName,Bio")] Model model)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("Id,PictureURL,FullName,Bio")] Model model)
        {
            if (id != model.Id)
            {
                return NotFound();
