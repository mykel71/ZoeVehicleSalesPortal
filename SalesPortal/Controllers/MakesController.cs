...
namespace SalesPortal.Controllers
{
    public class MakesController : Controller
    {
        ...
        public async Task<IActionResult> Create([Bind("Id,LogoURL,FullName,Bio")] Make make)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("Id,LogoURL,FullName,Bio")] Make make)
        {
            if (id != make.Id)
            {
                return NotFound();
        ...
        public async Task<IActionResult> DeleteConfirmed(int id)
        {
            ...
            {
                return Problem("Entity set 'AppDbContext.Makes'  is null.");
            }
            var make = await _context.Makes.FindAsync(id);
            if (make != null)
            {
